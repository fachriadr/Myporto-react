  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grip-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          <div className="flex items-center gap-3 mb-6 bg-zinc-800 w-fit p-4 rounded-2xl">
            ...
            <q>Kegagalan adalah sebuah data. Saya mengubahnya menjadi kode yang lebih kuat.</q>
          </div>
          <h1 className="text-4xl/tight font-bold mb-6">Hi, Saya Fachri Adryansyah</h1>
          <p className="text-base/loose mb-6 opacity-50 text-justify">
            Saya memiliki latar belakang di bidang Teknologi Informasi, dilengkapi dengan beragam pengalaman kerja di bidang TI Support, Usher, dan Warehouse Oprational. Kombinasi ini telah membentuk saya menjadi individu yang adaptif dan
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://raw.githubusercontent.com/Fachriadr/Myporto-react/assets/CV_Fachri Adryansyah.pdf" download="CV_Fachri Adryansyah.pdf" className="bg violet-700 p-4 rounded-2xl hover:bg-violet-600">
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <form
          action="https://formsubmit.co/fachriadryan0@gmail.com"
          method="POST"
